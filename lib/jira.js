...
(function() {
    ...
    // ## Remove an issue from the project's current sprint ##
    // ### Takes ###
    //
    // *  issueId: the id of the existing issue
    // *  callback: for when it's done
    ...
    //
    /**
     * Removes a given issue to a project's current sprint
     *
     * @param issueId
     * @param callback
     */
    this.removeIssueFromSprint = function(issueId, callback) {
