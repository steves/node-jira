...
var JiraApi = exports.JiraApi = function(protocol, host, port, username, password, apiVersion, verbose, strictSSL, oauth, basePath) {
    ...
    this.makeUri = function(pathname, altBase, altApiVersion) {
        var basePath = this.basePath || 'rest/api/';
        if (altBase != null) {
            basePath = altBase;
        }
