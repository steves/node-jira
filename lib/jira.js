...
(function() {
    ...
    this.getUnresolvedIssueCount = function(version, callback) {
        ...
        this.doRequest(options, function(error, response, body) {
            ...
            if (response.statusCode !== 200) {
                callback(response.statusCode + ': Unable to connect to JIRA during getUnresolvedIssueCount.');
                return;
            }
    ...
    this.getRemoteLinks = function getRemoteLinks(issueNumber, callback) {
        ...
        this.doRequest(options, function(error, response) {
            ...
            if (response.statusCode !== 200) {
                callback(response.statusCode + ': Unable to connect to JIRA during request for links.');
                return;
            }
    ...
    this.createRemoteLink = function createRemoteLink(issueNumber, remoteLink, callback) {
        ...
        this.doRequest(options, function(error, response) {
            ...
            if (response.statusCode !== 200) {
                callback(response.statusCode + ': Unable to connect to JIRA during remote link creation.');
                return;
            }
    ...
    this.searchUsers = function(username, startAt, maxResults, includeActive, includeInactive, callback) {
        ...
        this.doRequest(options, function(error, response, body) {
            ...
            if (response.statusCode !== 200) {
                callback(response.statusCode + ': Unable to connect to JIRA during user search.');
                return;
            }
    ...
    this.getUsersInGroup = function(groupName, startAt, maxResults, callback) {
        ...
        this.doRequest(options, function(error, response, body) {
            ...
            if (response.statusCode !== 200) {
                callback(response.statusCode + ': Unable to connect to JIRA during group search.');
                return;
            }
    ...
    this.addNewIssue = function(issue, callback) {
        ...
        this.doRequest(options, function(error, response, body) {
            ...
            if ((response.statusCode !== 200) && (response.statusCode !== 201)) {
                callback(response.statusCode + ': Unable to connect to JIRA during issue creation.');
                return;
            }
   ...
   */
    ...
    this.addNewComponent = function (component, callback) {
        ...
        this.doRequest(options, function (error, response, body) {
            ...
            if ((response.statusCode !== 200) && (response.statusCode !== 201)) {
                callback(response.statusCode + ': Unable to connect to JIRA during component add.');
                return;
            }
