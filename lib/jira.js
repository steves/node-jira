...
var JiraApi = exports.JiraApi = function(protocol, host, port, username, password, apiVersion, verbose, strictSSL) {
    ...
    this.makeOptions = function(overrides) {
        ...
        for (o in overrides) {
            console.log('Overriding '+o+' > '+options[o]+' with '+overrides[o]);
            options[o] = overrides[o];
        }
...
(function() {
    ...
    this.findIssue = function(issueNumber, callback) {
        ...
        var options = this.makeOptions({ uri: this.makeUri('/issue/' + issueNumber) });
    ...
    this.getProject = function(project, callback) {
        ...
        var options = this.makeOptions({ uri: this.makeUri('/project/' + project) });
    ...
    this.getLastSprintForRapidView = function(rapidViewId, callback) {
        ...
        var options = this.makeOptions({ uri: this.makeUri('/sprints/' + rapidViewId, 'rest/greenhopper/'), json: true });
    ...
    this.getVersions = function(project, callback) {
        ...
        var options = this.makeOptions({ uri: this.makeUri('/project/' + project + '/versions') });
