...
var url = require('url'),
  logger = console,
  OAuth = require("oauth");
var JiraApi = exports.JiraApi = function (protocol, host, port, username, password, apiVersion, agileApiVersion, verbose, strictSSL, oauth) {
  ...
  this.agileApiVersion = agileApiVersion;
...
(function () {
  ...
  this.findIssue = function (issueNumber, params, callback) {
    var options = {
  ...
  // ### Returns ###
  // *  error: string of the error
  // *  rapidViews: array of views
  this.getAllRapidViews = function (callback) {
    var options = {
      rejectUnauthorized: this.strictSSL,
      uri: this.makeUri('/rapidview', 'rest/greenhopper/', this.agileApiVersion),
      method: 'GET',
      json: true
    };
  ...
  this.findRapidView = function (projectName, callback) {
    var options = {
      rejectUnauthorized: this.strictSSL,
      uri: this.makeUri('/rapidviews/list', 'rest/greenhopper/', this.agileApiVersion),
      method: 'GET',
      json: true
    };
    this.doRequest(options, function (error, response) {
      ...
      if (response.body !== null) {
        ...
        for (var i = 0; i < rapidViews.length; i++) {
          if (rapidViews[i].name.toLowerCase() === projectName.toLowerCase()) {
            matchedViews.push(rapidViews[i]);
          }
        }
        callback(null, matchedViews[0]);
      }
    });
  };
  /**
   * Gets the Rapid View configuration.
   *
   * @param rapidViewId
   * @param callback
   */
  this.getRapidViewConfig = function (rapidViewId, callback) {
    var options = {
      rejectUnauthorized: this.strictSSL,
      uri: this.makeUri('/rapidviewconfig/editmodel?rapidViewId=' + rapidViewId, 'rest/greenhopper/', this.agileApiVersion),
      method: 'GET',
      json: true
    };
    this.doRequest(options, function (error, response, body) {
  ...
  this.getActiveSprintsForRapidView = function (rapidViewId, callback) {
    var options = {
      rejectUnauthorized: this.strictSSL,
      uri: this.makeUri('/sprintquery/' + rapidViewId, 'rest/greenhopper/', this.agileApiVersion),
      method: 'GET',
      json: true
    };
    this.doRequest(options, function (error, response) {
  ...
  // ## Get the last Sprint belonging to a Rapid View ##
  // ### Takes ###
  //
  // *  rapidViewId: the id for the rapid view
  // *  callback: for when it's done
  ...
  // *  sprints: the ?array? of sprints
  /**
   * Returns last sprint belonging to a Rapid View.
   *
   * @param rapidView ID
   * @param callback
   */
   ...
   * @param callback
   */
  this.getSprintIssues = function (rapidViewId, sprintId, callback) {
    var options = {
      rejectUnauthorized: this.strictSSL,
      uri: this.makeUri('/rapid/charts/sprintreport?rapidViewId=' + rapidViewId + '&sprintId=' + sprintId, 'rest/greenhopper/', this.agileApiVersion),
      method: 'GET',
      json: true
    };
    this.doRequest(options, function (error, response) {
  ...
  this.getAllRapidViewData = function (rapidViewId, sprintIds, callback) {
    ...
    var options = {
      rejectUnauthorized: this.strictSSL,
      uri: this.makeUri('/xboard/work/allData/?rapidViewId=' + rapidViewId + sprints, 'rest/greenhopper/', this.agileApiVersion),
      method: 'GET',
      json: true
    };
    this.doRequest(options, function (error, response) {
  ...
  this.addIssueToSprint = function (issueId, sprintId, callback) {
    var options = {
      rejectUnauthorized: this.strictSSL,
      uri: this.makeUri('/sprint/' + sprintId + '/issues/add', 'rest/greenhopper/', this.agileApiVersion),
      method: 'PUT',
  ...
  this.getBacklogForRapidView = function (rapidViewId, callback) {
    var options = {
      rejectUnauthorized: this.strictSSL,
      uri: this.makeUri('/xboard/plan/backlog/data?rapidViewId=' + rapidViewId, 'rest/greenhopper/', this.agileApiVersion),
      method: 'GET',
      json: true
    };
    this.doRequest(options, function (error, response) {
